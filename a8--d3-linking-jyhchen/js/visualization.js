...
((() => {
    ...
    d3.json('data/texas.json').then(data => {
        ...
        let dispatch = d3.dispatch('line_to_scatter', 'scatter_to_line');

        lcYearPoverty.selectionDispatcher(dispatch.on('line_to_scatter', spUnemployMurder.updateSelection));
        spUnemployMurder.selectionDispatcher(dispatch.on('scatter_to_line', lcYearPoverty.updateSelection));
